...
public class SimpleFormSearchAmbusaidi extends HttpServlet {
   private static final long serialVersionUID = 1L;

   public SimpleFormSearchAmbusaidi() {
      super();
   }
   ...
   void search(String keyword, HttpServletResponse response) throws IOException {
      ...
      try {
         ...
         if (keyword.isEmpty()) {
            ...
            String selectSQL = "SELECT * FROM MyTable WHERE LASTNAME LIKE ?";
         ...
         out.println("<a href=/CustomerRegistrationProject/simpleFormSearch.html>Search Data</a> <br>");
