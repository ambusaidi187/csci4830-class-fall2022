...
public class UtilPropAmbusaidi {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = "D:\\jee-2022-06\\PersonalProjectFinal\\PersonalProjectFinal\\CustomerRegistrationProject\\WebContent\\config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/webproject/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat9/webapps/CustomerRegistrationProject/config.properties";
